...
function About() {
  return (
    <div className="h-screen space-y-10  flex flex-col md:flex-row relative text-center md:text-left max-w-7xl py-20 justify-evenly mx-auto items-center ">
      ...
      src="./maich.jpg" alt="#"
       className="-mb-20 mt-20 top-30 md:mb-10 top-42 xl:ml-0 self-center flex-shrink-0 w-32 h-32 rounded-full  object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[450px] xl:h-[550px]"/>
      <motion.div 
       initial={{
        y:200, opacity:0
      }}
