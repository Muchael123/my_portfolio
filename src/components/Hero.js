...
function Hero(){
  return (
    ...
    <Typewriter
     ...
     >
            <a href="#about" className='px-2 py-5 uppercase md:px-6 border-[#242424] rounded-full text-sm tracking-widest cursor-pointer  text-red-500 transition-all hover:border-[#0ceb04]/40 hover:text-[#0ceb04]/40'>about</a>
            <a href='#experience'>
