...
export const socialMediaProfiles = [
  { title: 'Linkedin', href: 'https://www.linkedin.com/in/michael-maina-087227235?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app', icon: LinkedinIcon },
  { title: 'GitHub', href: 'https://github.com/Muchael123', icon: GitHubIcon },
];
