...
function ECard() {
  return (
    <article className=" flex flex-col h-fit rounded-xl items-center space-y-7 flex-shrink-0 w-[98%] md:w-[450px] xl:w-[650px] snap-center bg-[#494949] p-5 xl:p-10 opacity-40 hover:opacity-100">
        <motion.img
